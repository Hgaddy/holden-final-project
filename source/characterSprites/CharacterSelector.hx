...
class CharacterSelector extends FlxSprite
{
    ...
    private function selectGraphic() {
        ...
        switch (type) {
            case Moss: newGraphic = AssetPaths.BigMoss__png;
            case Navy: newGraphic = AssetPaths.BigNavy__png;
            case Rose: newGraphic = AssetPaths.BigRose__png;
            case Sand: newGraphic = AssetPaths.BigSand__png;
        }
